  ...
  return (
    <SectionShell>
      ...
      <nav aria-label="Template views" className="mb-base flex items-center gap-base">
        <Tab href="/configuration/templates" active={view === "yours"}>
          Yours
        </Tab>
        <Tab href="/configuration/templates?view=library" active={view === "library"}>
          From Meta
        </Tab>
      </nav>
      ...
      <div className="mb-lg flex flex-wrap items-center gap-sm">
        {view === "yours" ? (
          <Button asChild>
            <Link href="/configuration/templates/new">New template</Link>
          </Button>
        ) : (
      ...
      {templates.length > 0 ? (
        ...
        <EmptyState
          ...
          description={
            view === "library"
              ? EMPTY_COPY["configuration/templates#library"]
              : EMPTY_COPY["configuration/templates"]
          }
        />
      )}
    </SectionShell>
